...
final class AutorController extends AbstractController
{
    ...
    #[Route('/{autor_id}', name: 'app_autor_show', methods: ['GET'])]
    ...
    #[Route('/{autor_id}/edit', name: 'app_autor_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{autor_id}', name: 'app_autor_delete', methods: ['POST'])]
    public function delete(Request $request, Autor $autor, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$autor->getAutor_id(), $request->getPayload()->getString('_token'))) {
